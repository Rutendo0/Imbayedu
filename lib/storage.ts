...
class InMemoryStorage implements IStorage {
  ...
  private seed() {
    ...
    this.createArtwork({
      title: "Market Day",
      description: "Bustling market energy abstracted into shape and color.",
      price: 325,
    ...
    this.createArtwork({
      title: "Homestead",
      description: "Calm composition inspired by homestead memories.",
      price: 295,
      imageUrl: "/img/artwork/WhatsApp Image 2025-05-15 at 09.30.08 (2).jpeg",
      categoryId: 1,
      collectionId: 1,
    ...
    this.createArtwork({
      ...
      description: "Lyrical marks and colors inspired by birdsong.",
      price: 285,
    ...
    this.createArtwork({
      ...
      description: "Layered blues and earth tones suggest a river crossing.",
      price: 335,
    ...
    this.createArtwork({
      title: "City Sunset",
      description: "City silhouettes dissolving into sunset tones.",
      price: 345,
    ...
    this.createArtwork({
      title: "Ancestral Path",
      description: "Interwoven lines recalling ancestral pathways.",
      price: 320,
    ...
    this.createArtwork({
      title: "Gathering",
      description: "Circular forms suggesting community gatherings.",
      price: 300,
    ...
    this.createArtwork({
      title: "New Dawn",
      description: "Radiant layers symbolizing a new beginning.",
      price: 310,
    ...
    this.createArtwork({
      title: "Market Rhythm",
      description: "Rhythmic brushwork inspired by market movement.",
      price: 295,
    ...
    this.createArtwork({
      ...
      description: "Soft edges and warm tones of evening storytelling.",
      price: 340,
    ...
    this.createArtwork({
      title: "Ceremony",
      description: "Structured marks referencing ceremonial patterns.",
      price: 355,
    ...
    this.createArtwork({
      ...
      description: "Light and shadow play across textured forms.",
      price: 325,
    ...
    this.createArtwork({
      title: "Village Paths",
      description: "Intersecting paths and patterns of daily life.",
      price: 305,
    ...
    this.createArtwork({
      title: "Harvest Dance",
      description: "Celebration motifs and vibrant rustic colors.",
      price: 315,
    ...
    this.createArtwork({
      title: "Blue Horizon",
      description: "Horizontal bands of blues suggesting distant horizons.",
      price: 290,
    ...
    this.createArtwork({
      ...
      description: "Fresh color fields evoking a gentle morning breeze.",
      price: 300,
      imageUrl: "/img/artwork/WhatsApp Image 2025-05-21 at 15.52.14.jpeg",
      categoryId: 1,
      collectionId: 3,
    ...
    this.createArtwork({
      title: "Red Earth",
      description: "Earthy reds and ochres with textured depth.",
      price: 335,
    ...
    this.createArtwork({
      title: "Blue Song",
      description: "Song-like repetition of blue tonal shapes.",
      price: 310,
      imageUrl: "/img/artwork/WhatsApp Image 2025-05-22 at 11.04.43 (1).jpeg",
      categoryId: 1,
      collectionId: 3,
      dimensions: "90 x 110 cm",
      medium: "Acrylic on canvas",
    ...
    this.createArtwork({
      title: "Sun on Stone",
      description: "Warm light across stone-like textured forms.",
      price: 320,
    ...
    this.createArtwork({
      title: "River Stones",
      description: "Pebble-like forms and cool water tones.",
      price: 285,
      imageUrl: "/img/artwork/WhatsApp Image 2025-05-22 at 11.04.44 (1).jpeg",
      categoryId: 1,
      collectionId: 3,
      dimensions: "75 x 95 cm",
      medium: "Acrylic on canvas",
    ...
    this.createArtwork({
      title: "Amber Field",
      description: "Amber hues and textured fields of color.",
      price: 295,
    ...
    this.createArtwork({
      title: "Green Chorus",
      description: "Layered greens in chorus-like repetition.",
      price: 305,
      imageUrl: "/img/artwork/WhatsApp Image 2025-05-22 at 11.04.45 (1).jpeg",
      categoryId: 1,
      collectionId: 2,
      dimensions: "80 x 100 cm",
      medium: "Acrylic on canvas",
    ...
    this.createArtwork({
      title: "Evening Calm",
      description: "Soft neutrals and gentle transitions.",
      price: 290,
    ...
    this.createArtwork({
      title: "Forest Path",
      description: "Pathway through layered green abstractions.",
      price: 315,
    ...
    this.createArtwork({
      title: "Orange Sky",
      description: "High-chroma orange fields with contrasting marks.",
      price: 335,
    ...
    this.createArtwork({
      title: "Quiet River",
      description: "Horizontal bands suggest a quiet flowing river.",
      price: 300,
    ...
    this.createArtwork({
      title: "Golden Fields",
      description: "Golden fields in layered textures and forms.",
      price: 345,
