...
export async function POST() {
  try {
    ...
    const artworksData: InsertArtwork[] = [
      ...
      { title: 'Sunset Reflections', description: 'A captivating landscape depicting the warm hues of an African sunset reflecting over water.', price: 300, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.27.23.jpeg', categoryId: catPaintings.id, collectionId: collAbstract.id, dimensions: '80 x 100 cm', medium: 'Oil on canvas', year: '2024', inStock: false, featured: true, artistId: oneal.id },
      ...
      { title: 'Cultural Heritage 2', description: 'A celebration of African cultural heritage through symbolic imagery and traditional patterns', price: 290, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.00.jpeg', categoryId: catMixedMedia.id, collectionId: collMixed.id, dimensions: '90 x 120 cm', medium: 'Oil on canvas', year: '2023', inStock: false, featured: true, artistId: tunga.id },
      { title: 'Cultural Heritage 3', description: 'A celebration of African cultural heritage through symbolic imagery and traditional patterns', price: 290, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.00 (1).jpeg', categoryId: catPaintings.id, collectionId: collCultural.id, dimensions: '90 x 120 cm', medium: 'Oil on canvas', year: '2023', inStock: false, featured: true, artistId: tunga.id },
      { title: 'Colorful Abstraction', description: 'A vibrant abstract composition with bold colors and dynamic forms creating visual harmony.', price: 420, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.00 (2).jpeg', categoryId: catPaintings.id, collectionId: collAbstract.id, dimensions: '80 x 80 cm', medium: 'Mixed media on canvas', year: '2023', inStock: false, featured: true, artistId: tunga.id },
      { title: 'Colorful Abstraction 2', description: 'A vibrant abstract composition with bold colors and dynamic forms creating visual harmony.', price: 420, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.01.jpeg', categoryId: catPaintings.id, collectionId: collAbstract.id, dimensions: '80 x 80 cm', medium: 'Mixed media on canvas', year: '2023', inStock: false, featured: true, artistId: tunga.id },
      ...
      { title: 'Colorful Abstraction 3', description: 'A vibrant abstract composition with bold colors and dynamic forms creating visual harmony.', price: 420, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.01 (1).jpeg', categoryId: catPaintings.id, collectionId: collCultural.id, dimensions: '80 x 80 cm', medium: 'Mixed media on canvas', year: '2023', inStock: false, featured: true, artistId: tunga.id },
      { title: 'Abstract Patterns', description: 'A mesmerizing exploration of patterns and textures through abstract composition.', price: 530, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.02.jpeg', categoryId: catPaintings.id, collectionId: collAbstract.id, dimensions: '80 x 100 cm', medium: 'Acrylic on canvas', year: '2024', inStock: false, featured: true, artistId: tunga.id },
      ...
      { title: 'Abstract Patterns 3', description: 'A mesmerizing exploration of patterns and textures through abstract composition.', price: 530, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.02 (2).jpeg', categoryId: catPaintings.id, collectionId: collAbstract.id, dimensions: '80 x 100 cm', medium: 'Oil on canvas', year: '2024', inStock: false, featured: true, artistId: tunga.id },
      ...
      { title: 'Unity in Diversity', description: 'An exploration of African unity through diverse cultural symbols and patterns, celebrating the continent\'s rich heritage.', price: 460, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.03 (1).jpeg', categoryId: catPaintings.id, collectionId: collAbstract.id, dimensions: '100 x 100 cm', medium: 'Acrylic on canvas', year: '2023', inStock: false, featured: true, artistId: tunga.id },
      { title: 'Soulful Portrait', description: 'A soulful portrait that captures the depth and spirit of its subject through expressive techniques.', price: 580, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.03 (2).jpeg', categoryId: catMixedMedia.id, collectionId: collCultural.id, dimensions: '90 x 120 cm', medium: 'Oil on canvas', year: '2024', inStock: false, featured: true, artistId: tunga.id },
      ...
      { title: 'Vibrant Abstraction', description: 'A colorful abstract piece with geometric elements creating a sense of movement and rhythm.', price: 569, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.05.jpeg', categoryId: catPaintings.id, collectionId: collAbstract.id, dimensions: '85 x 100 cm', medium: 'Acrylic on canvas', year: '2023', inStock: false, featured: true, artistId: tunga.id },
      { title: 'Vibrant Abstraction 2', description: 'A colorful abstract piece with geometric elements creating a sense of movement and rhythm.', price: 569, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.05 (2).jpeg', categoryId: catPaintings.id, collectionId: collAbstract.id, dimensions: '85 x 100 cm', medium: 'Acrylic on canvas', year: '2023', inStock: false, featured: false, artistId: tunga.id },
      ...
      { title: 'Expressionist Landscape', description: 'A bold expressionist interpretation of landscape elements with expressive brushwork.', price: 500, imageUrl: '/img/artwork/WhatsApp Image 2025-05-15 at 09.30.08.jpeg', categoryId: catPaintings.id, collectionId: collAbstract.id, dimensions: '100 x 120 cm', medium: 'Acrylic on canvas', year: '2024', inStock: false, featured: false, artistId: tunga.id },
