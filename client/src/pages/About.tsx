...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About Imbayedu Art Gallery</title>
        <meta name="description" content="Learn about Imbayedu Art Gallery, our mission to showcase exceptional contemporary African art, and our commitment to supporting talented artists." />
      </Helmet>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-neutral-700 mb-4">
                Imbayedu Art Gallery was founded in 2018 with a singular mission: to showcase the extraordinary talent of contemporary African artists to a global audience.
              </p>
              <p className="text-neutral-700 mb-4">
            ...
            <div>
              <img 
                ...
                alt="Imbayedu Art Gallery Interior" 
