...
const Artists = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Artists | Imbayedu Art Collective</title>
        <meta name="description" content="Meet the talented artists behind our exceptional collection of African art. Learn about their backgrounds, inspirations, and artistic styles." />
      </Helmet>
