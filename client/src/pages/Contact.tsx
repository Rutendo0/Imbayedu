...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | Imbayedu Art Collective</title>
        <meta name="description" content="Contact Imbayedu Art Collective for inquiries about our artwork, commissioning pieces, gallery visits, or any other questions. We'd love to hear from you!" />
      </Helmet>
