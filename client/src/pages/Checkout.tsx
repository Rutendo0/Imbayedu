...
const Checkout = () => {
  ...
  if (orderComplete) {
    return (
      <>
        <Helmet>
          <title>Order Confirmation | Imbayedu Art Gallery</title>
          <meta name="description" content="Thank you for your order! Your purchase from Imbayedu Art Gallery has been received and is being processed." />
        </Helmet>
  ...
  return (
    <>
      <Helmet>
        <title>Checkout | Imbayedu Art Gallery</title>
        <meta name="description" content="Complete your purchase at Imbayedu Art Gallery. Secure checkout for your selected artworks." />
      </Helmet>
                    ...
                    {selectedPaymentMethod === "bank-transfer" && (
                      <div className="mt-6 p-4 bg-neutral-50 rounded-md">
                        ...
                        <div className="mt-4 space-y-2 text-sm">
                          ...
                          <p><span className="font-medium">Account Name:</span> Imbayedu Art Gallery</p>
